...
urlpatterns = [
    ...
    path(
        "tickets/<slug:ticket_uuid>/update/",
        views_ut.ticket_update,
        name="ticket_update",
    ),
    path(
        "tickets/<slug:ticket_uuid>/close/",
        views_ut.ticket_close,
        name="ticket_close",
    ),
    path(
        "tickets/<slug:ticket_uuid>/reopen/",
        views_ut.ticket_reopen,
        name="ticket_reopen",
    ),
    path(
        "tickets/<slug:ticket_uuid>/reply/",
        views_ut.ticket_reply,
        name="ticket_reply",
    ),
    path(
        "tickets/<slug:ticket_uuid>/merge/",
        views_ut.ticket_merge,
        name="ticket_merge",
    ),
    path(
        "tickets/<slug:ticket_uuid>/strand/",
        views_ut.ticket_strand,
        name="ticket_strand",
    ),
    path(
    ...
    path(
        "tickets/<slug:ticket_uuid>/messages/",
        views_ut.ticket_messages,
